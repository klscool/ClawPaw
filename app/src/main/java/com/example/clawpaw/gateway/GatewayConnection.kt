    ...
    private fun sendConnectRequest(challengeNonce: String, challengeTs: Long) {
        try {
            ...
            val params = JSONObject().apply {
                ...
                put("commands", if (role == "node") org.json.JSONArray().apply {
                    put("device_status")
                    put("device_info")
                    put("device.health")
                    ...
                    put("calendar.events")
                    put("get_wifi_name")
                    put("get_screen_state")
                    put("vibrate")
                    put("screen_on")
                    put("volume.get")
                    put("volume.set")
                    put("file.read_text")
                    put("file.read_base64")
                    put("sensors.steps")
                    put("sensors.light")
                    put("motion.pedometer")
                    put("motion.activity")
                    put("sensors.info")
                    put("bluetooth.list")
                    put("wifi.info")
                    ...
                    put("click")
                    put("input_text")
                    put("input_text_direct")
                    put("swipe")
                    put("long_press")
                    put("two_finger_swipe_same")
                    put("two_finger_swipe_opposite")
                    put("back")
                    put("open_schema")
                } else org.json.JSONArray())
