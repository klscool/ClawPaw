...
在电脑端用 OpenClaw 控制手机，需要安装对应的 **OpenClaw Skill**，按 Skill 说明配置后即可用自然语言或 `nodes invoke` 操作本机。
...
Skill 内含命令列表、权限说明与使用示例，安装 ClawPaw App 后按 Skill 文档完成 Gateway 或 HTTP 配置即可使用。
